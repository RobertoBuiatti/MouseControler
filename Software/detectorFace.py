        ...
        if results.multi_face_landmarks:
            for face_landmarks in results.multi_face_landmarks:
                ...
                for i, landmark in enumerate(face_landmarks.landmark):
                    ...
                    if i == 33:  # Ponto 33 é o canto externo do olho esquerdo
                        left_eye_x = x
                        left_eye_y = y
                    if i == 263:  # Ponto 263 é o canto externo do olho direito
                        right_eye_x = x
                        right_eye_y = y
                ...
                if face_center_x is not None and face_center_y is not None:
                    ...
                    if len(face_positions) > 1:
                        ...
                        if delta_x > 1 or delta_y > 1:
                            ...
                            face_color = (0, 0, 255)  # Vermelho para movimento
                        else:
                            # Reseta o fator de aceleração quando o movimento para
                            acceleration_factor = 0.5
                            face_color = (0, 255, 0)  # Verde para sem movimento
                ...
                for idx, landmark in enumerate(face_landmarks.landmark):
                    if idx in {33, 263}:  # Desenhar pontos dos olhos
                        x = int(landmark.x * frame_width)
                        y = int(landmark.y * frame_height)
